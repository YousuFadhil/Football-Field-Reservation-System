	...
	<div class="auto-style1">
		<table align="center" style="width: 70%; " class="auto-style5">
			...
			<tr>
				...
				number</span></td>
				<td class="auto-style12">
				<input name="phone" type="text" maxlength="8" required />&nbsp;</td>
			</tr>
			<tr>
				<td class="auto-style7" style="width: 381px">Email</td>
				<td class="auto-style12">
				<input name="email" type="email" maxlength="30" required />&nbsp;</td>
			</tr>
			<tr>
				<td class="auto-style11" style="width: 381px; mso-ascii-theme-font: minor-latin; mso-fareast-font-family: &quot;Times New Roman&quot;; mso-hansi-theme-font: minor-latin; mso-bidi-theme-font: minor-latin; mso-ansi-language: EN-IN; mso-fareast-language: EN-IN; mso-bidi-language: AR-SA;">
				Password</td>
				<td class="auto-style12">
				<input name="pass" type="password" maxlength="15" required />&nbsp;</td>
			</tr>
			<tr>
				...
				<td class="auto-style12">
				<select name="s_q">
				<option selected="selected" value="x">Choose a question</option>
			...
			<tr>
				...
				Security Answer</td>
				<td class="auto-style12">
				<input name="s_ans" type="text" maxlength="30" required />&nbsp;</td>
			</tr>
			<tr>
				<td class="auto-style12" style="width: 381px">
				User Type</td>
				<td class="auto-style12">
				<input name="type" type="radio" value="P" />&nbsp;Player<input name="type" type="radio" value="O" />Owner</td>
			</tr>
			<tr>
				<td class="auto-style3" style="width: 381px">
